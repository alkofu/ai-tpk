...
> `src/agents/` is the canonical source committed to this repo. `claude/agents/` and `opencode/agents/` are local build artifacts generated by `./install.sh` and are not tracked in git.
...
**Configuration File:** `src/agents/dungeonmaster.md`
...
**Configuration File:** `src/agents/quill.md`
...
**Configuration File:** `src/agents/riskmancer.md`
...
**Configuration File:** `src/agents/pathfinder.md`
...
**Configuration File:** `src/agents/knotcutter.md`
...
**Configuration File:** `src/agents/ruinor.md`
...
**Configuration File:** `src/agents/windwarden.md`
...
**Configuration File:** `src/agents/truthhammer.md`
...
**Configuration File:** `src/agents/bitsmith.md`
...
**Configuration File:** `src/agents/talekeeper.md`
...
- Read: Session chronicles in `logs/`, agent configs in `src/agents/`, existing lessons in `lessons/`
...
**Configuration File:** `src/agents/everwise.md`
